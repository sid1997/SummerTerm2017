...
logreg1 = linear_model.LogisticRegression(C=0.00001,class_weight='balanced')#applying Logistic Regression model with respective parameters
logreg1.fit(X_train,Y1_train)#fitting model on training set 
y1_pred = logreg1.predict(X_test)#making predictions on test set and storing it in y1_pred
#print y1_pred
...
logreg2 = linear_model.LogisticRegression(C=1,class_weight='balanced')
...
logreg3 = linear_model.LogisticRegression(C=1,class_weight='balanced')
logreg3.fit(X_train,Y3_train)
y3_pred = logreg3.predict(X_test)
#print y3_pred
...
logreg4 = linear_model.LogisticRegression(C=0.01,class_weight='balanced')
logreg4.fit(X_train,Y4_train)
y4_pred = logreg4.predict(X_test)
#print y4_pred
#print Y4_test
